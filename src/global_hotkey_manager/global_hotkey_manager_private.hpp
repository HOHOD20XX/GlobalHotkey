...
public:
    ...
    virtual int start() = 0;
    virtual int end() = 0;
    virtual int add(const KeyCombination& kc, const std::function<void()>& fn, bool autoRepeat = false) = 0;
    virtual int add(const KeyCombination& kc, std::function<void()>&& fn, bool autoRepeat = false) = 0;
