...
public:
    ...
    int start() override;
    int end() override;
    int add(const KeyCombination& kc, VoidFunc func, bool autoRepeat = false) override;
    int add(const KeyCombination& kc, ArgFunc func, Arg arg, bool autoRepeat = false) override;
