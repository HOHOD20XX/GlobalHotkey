...
int x11Key(const Key& key) noexcept
{
    switch (key)
    {
        ...
        case Key_Modi_Meta_Left:        return XK_Meta_L;
        case Key_Modi_Meta_Right:       return XK_Meta_R;
        case Key_Modi_Ctrl:             return 0;   // Not supported.
        case Key_Modi_Ctrl_Left:        return XK_Control_L;
        case Key_Modi_Ctrl_Right:       return XK_Control_R;
        case Key_Modi_Alt:              return 0;   // Not supported.
        case Key_Modi_Alt_Left:         return XK_Alt_L;
        case Key_Modi_Alt_Right:        return XK_Alt_R;
        case Key_Modi_Shift:            return 0;   // Not supported.
        case Key_Modi_Shift_Left:       return XK_Shift_L;
        case Key_Modi_Shift_Right:      return XK_Shift_R;
...
Key getKeyFromX11Key(int x11Key) noexcept
{
    switch (x11Key)
    {
        ...
        // Modifier keys.
        case XK_Meta_L:                return Key_Modi_Meta_Left;
        case XK_Meta_R:                return Key_Modi_Meta_Right;
        case XK_Control_L:             return Key_Modi_Ctrl_Left;
        case XK_Control_R:             return Key_Modi_Ctrl_Right;
        case XK_Alt_L:                 return Key_Modi_Alt_Left;
        case XK_Alt_R:                 return Key_Modi_Alt_Right;
        case XK_Shift_L:               return Key_Modi_Shift_Left;
        case XK_Shift_R:               return Key_Modi_Shift_Right;
